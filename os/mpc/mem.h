...
#define	FE1	0x00100
#define	MSR_IP	0x00040	/* =0, vector to nnnnn; =1, vector to FFFnnnnn; "IP" clashes with new IP stack */
...
#undef KZERO	/* used when MMU off */
#define	KZERO	0	/* used when MMU off */

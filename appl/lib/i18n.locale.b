...
firstday = 0;			# First day of week in this locale (0 => Sunday,
				# 1 => Monday, etc.)
###
# LC_NUMERIC
###
...
int_curr_symbol = "USD ";	# String used to represent locale currency
				# units outside of the locale

currency_symbol = "$";		# String used to represent locale currency
